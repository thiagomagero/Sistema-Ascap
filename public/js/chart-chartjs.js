...
jQuery(function($) {
    ...
    /*--------------------------------
        Chart Js Chart
     --------------------------------*/
    CRESTADMIN_SETTINGS.chartJS = function() {
 ...
 if($("#bar-chartjs").length){
        ...
        var barChartData = {
            ...
            datasets: [{
                ...
                strokeColor: "rgba(86,80,144,0.8)",
                highlightFill: "rgba(86,80,144,0.8)",
                highlightStroke: "rgba(86,80,144,1)",
 ...
 if($("#line-chartjs").length){
        ...
        var lineChartData = {
            ...
            datasets: [{
                ...
                strokeColor: "rgba(86,80,144,1)",
                pointColor: "rgba(86,80,144,1)",
                pointStrokeColor: "#fff",
                pointHighlightFill: "#fff",
                pointHighlightStroke: "rgba(86,80,144,1)",
                data: [randomScalingFactor(), randomScalingFactor(), randomScalingFactor(), randomScalingFactor(), randomScalingFactor(), randomScalingFactor(), randomScalingFactor()]
            }, {
 ...
 if($("#pie-chartjs").length){
        ...
        var pieData = [{
                ...
                value: 150,
                color: "rgba(86,80,144,1)",
                highlight: "rgba(86,80,144,0.8)",
                label: "Primary"
            }, {
                value: 50,
                color: "#ffd014",
