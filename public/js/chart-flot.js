...
jQuery(function($) {
    ...
    /*--------------------------------
        Flot Chart
     --------------------------------*/
    CRESTADMIN_SETTINGS.chartFlot = function() {
...
if($("#flotpie").length){
        ...
        $("#pieexample-1").click(function() {
            ...
            $.plot(flotpie, data, {
                ...
                colors: ["#565090", "#4bb5ff", "#ff5f74", "#ffd014", "#797979"],
                grid: {
                    hoverable: true,
                    clickable: true
                },
        ...
        $("#pieexample-12").click(function() {
            ...
            $.plot(flotpie, data, {
                ...
                colors: ["#565090", "#4bb5ff", "#ff5f74", "#ffd014", "#797979", "#da2527"],
                grid: {
                    hoverable: true,
                    clickable: true
                },
