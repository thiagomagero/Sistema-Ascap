...
<body class=" ">
  ...
  <script>window.jQuery || document.write('<script src="<?php echo e(asset('js/jquery-1.12.4.min.js')); ?>"><\/script>');</script>
  ...
  <script src="<?php echo e(asset('plugins/jquery-validation/js/metodos-adicionais.min.js')); ?>"></script>
